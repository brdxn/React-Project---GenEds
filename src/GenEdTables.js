...
export default class GenEdTables extends Component {
    ...
    render() {
        return <div>
                   <h1 className="bg-primary text-white text-center p-4 m-2 ">
                      Display GenEd Courses
                  </h1>
          <BrowserRouter>
                <div>
                  <NavLink to="/AcademicFoundation" className="btn btn-sm m-2">Academic Foundation</NavLink> | {" "}
                  <NavLink to="/Distributive" className="btn btn-sm m-2">Distributive</NavLink> | {" "}
                  <NavLink to="/AdditionalCourses" className="btn btn-sm m-2">Additional Courses</NavLink>
                </div>

            <Routes>
              <Route path="/AcademicFoundation" element={
                    <CourseDisplay 
              ...
              <Route path="/AdditionalCourses" element={
                    <CourseDisplay 
